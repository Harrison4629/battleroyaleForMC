...
public class ArmorPlateItem4 extends AbstractUsableItem {
    private static final int USE_DURATION = 35;
    private static final int ABSORPTION_VALUE = 4;
    ...
    protected String getTooltipTranslationKey() {
        return "item.battleroyale.armor_plate_4.tooltip";
    }

    @Override
    protected String getUseTooltipTranslationKey() {
        return "item.battleroyale.armor_plate_4.tooltip.use";
    }
