...
public class ArmorPlateItem2 extends Item {
    private static final int USE_DURATION = 40;
    private static final int ARMOR_VALUE = 12;
        ...
        if (entity instanceof Player) {
            ...
            if (timeUsed < USE_DURATION) {
                ...
                if (!level.isClientSide) {
                    player.displayClientMessage(Component.translatable("item.battleroyale.armor_plate_2.heal_fail")
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.battleroyale.armor_plate_2.tooltip")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.battleroyale.armor_plate_2.tooltip.use")
