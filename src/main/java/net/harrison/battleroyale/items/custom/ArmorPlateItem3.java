...
public class ArmorPlateItem3 extends Item {
    private static final int USE_DURATION = 60;
    private static final int ARMOR_VALUE = 16;
        ...
        if (entity instanceof Player) {
            ...
            if (timeUsed < USE_DURATION) {
                ...
                if (!level.isClientSide) {
                    player.displayClientMessage(Component.translatable("item.battleroyale.armor_plate_3.heal_fail")
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player) {
            ...
            if (!level.isClientSide) {
                ...
                // 播放装备声音
                level.playSound(null, player.getX(), player.getY(), player.getZ(),
                        SoundEvents.ARMOR_EQUIP_GOLD, SoundSource.PLAYERS, 0.5F, 1.0F);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.battleroyale.armor_plate_3.tooltip")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.battleroyale.armor_plate_3.tooltip.use")
