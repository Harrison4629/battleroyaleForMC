...
public class MedkitItem extends Item {
        ...
        if (entity instanceof Player) {
            ...
            if (timeUsed < USE_DURATION) {
                ...
                if (!level.isClientSide) {
                    player.displayClientMessage(Component.translatable("item.battleroyale.medkit.heal_fail")
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.battleroyale.medkit.tooltip")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.battleroyale.medkit.tooltip.use")
